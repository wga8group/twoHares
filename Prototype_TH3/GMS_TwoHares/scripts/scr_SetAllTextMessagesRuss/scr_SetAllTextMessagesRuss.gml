...
//---------------------------------level 1------------------------------------
global.textFirstLevelWakeUp1 = "АЛЕША: \nОох, моя голова...";
global.textFirstLevelWakeUp2 = "АЛЕША: \nТак, нужно быстрее собраться на работу, главное ничего не забыть.";
...
global.textSecondLevelProt_1 = "АЛЕША:\nКаков привет, таков и ответ...";
...
global.textSecondLevelBossChoice[3] = "АЛЕША:\n...";
...
global.textThirdLevelDoor_1 = "АЛЕША:\nСтоп! Бутылка...";
global.textThirdLevelDoor_2 = "АЛЕША:\nГлупо упускать свой шанс проверить Виктора на причастность к тому убийству.";

//---------------------------------level 4------------------------------------
global.textFourthLevelDoor = "АЛЕША:\nЛучше туда пока не соваться, рискую попасть под подозрение.";
global.textFourthLevelItem3 = "АЛЕША:\nНаша компания как спрут захватывает все большие сферы жизни общества. Скоро мы открываем свой ..., еще наши специалисты придумали кукурузные хлопья от угревой сыпи, а также игровую консоль для собак.";
global.textFourthLevelItem4_1 = "АЛЕША:\nЭх, смотрю ты так и не починился";
global.textFourthLevelItem4_2 = "АЛЕША:\nНу давай же.. ";
global.textFourthLevelItem5 = "АЛЕША:\nВремя так медленно идет... Как будто его нет.";
global.textFourthLevelItem6 = "АЛЕША:\nПросто мечта! Когда-нибудь накоплю на такой. ";
global.textFourthLevelItem7 = "АЛЕША:\nЗапись на маникюр, бухгалтерия... Ну очень интересно.";
...
global.textFourthLevelCourier_2 = "АЛЕША:\nНу чего? Опять решил поиздеваться? ";
...
global.textOffice4PhoneMessage4 = "АЛЕША:\nМда уж, приплыли.. Как же мне теперь ему в глаза смотреть.";	

global.textTakeScrewdriverMessage = "АЛЕША:\nОпа, отвертка.";	
global.textTakePasteMessage = "АЛЕША:\nОпа, термо-паста.";	
